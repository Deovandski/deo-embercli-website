...
export default Ember.Controller.extend({
  ...
  PUFF_MT_ATM: 9.6, PUFF_MT_VAC: 20, PUFF_COST: 150, PUFF_FF: 8.5, PUFF_MASS: 0.09,
  ...
  // Radial Mounted Engine Constants (MT values are in KN.)
  puffAmount: 0, puffTotalCost: 0, puffFuelNeeded: 0, puffKN: 0,
  thudAmount: 0, thudTotalCost: 0, thudFuelNeeded: 0, thudKN: 0,
  twitchAmount: 0, twitchTotalCost: 0, twitchFuelNeeded: 0, twitchKN: 0,
  spiderAmount: 0, spiderTotalCost: 0, spiderFuelNeeded: 0, spiderKN: 0,
  // Tiny Mounted Engine Constants (MT values are in KN.)
  sparkAmount: 0, sparkTotalCost: 0, sparkFuelNeeded: 0, sparkKN: 0,
  antAmount: 0, antTotalCost: 0, antFuelNeeded: 0, antKN: 0,
  // Small Mounted Engine Constants (MT values are in KN.)
  nervAmount: 0, nervTotalCost: 0, nervFuelNeeded: 0, nervKN: 0,
  dartAmount: 0, dartTotalCost: 0, dartFuelNeeded: 0, dartKN: 0,
  rapierAmount: 0, rapierTotalCost: 0, rapierFuelNeeded: 0, rapierKN: 0,
  vectorAmount: 0, vectorTotalCost: 0, vectorFuelNeeded: 0, vectorKN: 0,
  swivelAmount: 0, swivelTotalCost: 0, swivelFuelNeeded: 0, swivelKN: 0,
  reliantAmount: 0, reliantTotalCost: 0, reliantFuelNeeded: 0, reliantKN: 0,
  terrierAmount: 0, terrierTotalCost: 0, terrierFuelNeeded: 0, terrierKN: 0,
  // Large Mounted Engine Constants (MT values are in KN.)
  twinboarAmount: 0, twinboarTotalCost: 0, twinboarFuelNeeded: 0, twinKN: 0,
  mainsalAmount: 0, mainsalTotalCost: 0, mainsalFuelNeeded: 0, mainsalKN: 0,
  skipperAmount: 0, skipperTotalCost: 0, skipperFuelNeeded: 0, skipperKN: 0,
  poodleAmount: 0, poodleTotalCost: 0, poodleFuelNeeded: 0, poodleKN: 0,
  // Extra Large Mounted Engine Constants (MT values are in KN.)
  mammothAmount: 0, mammothTotalCost: 0, mammotFuelNeeded: 0, mammotKN: 0,
  rhinoAmount: 0, rhinoTotalCost: 0,rhinoFuelNeeded: 0, rhinoKN: 0,
